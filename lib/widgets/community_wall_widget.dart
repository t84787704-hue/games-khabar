...
class CommunityWallWidget extends StatefulWidget {
  const CommunityWallWidget({super.key});

  @override
  State<CommunityWallWidget> createState() => _CommunityWallWidgetState();
}

class _CommunityWallWidgetState extends State<CommunityWallWidget> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
                        ...
                        children: [
                          ...
                          ConstrainedBox(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                color: _communityService.isUserVIP ? neonGreen : textWhite,
                                fontSize: 11,
                                fontWeight: FontWeight.bold,
                              ),
                            ),
                          ...
                          const SizedBox(width: 4),
                          Icon(Icons.edit, size: 10, color: textGray),
                        ],
                      ),
                    ),
                  ),
              ...
              Text(
                'Apna squad banayein, gameplay tips share karein aur doston se connect hon.',
        ...
        // Filter Chips (All, BGMI, GTA VI, Valorant)
        Padding(
        ...
        Padding(
          ...
          child: Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                // Composer top row: game tag choice if filter is "All"
                Row(
                  children: [
                    CircleAvatar(
                      radius: 14,
                    ...
                    const Spacer(),
                    // Game selector pill for the post
                    Container(
                ...
                // Composer Footer: Quick tip + Post Button
                Row(
        ...
        // StreamBuilder for community posts
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: Icon(Icons.chat_bubble_outline_rounded, color: neonGreen, size: 32),
                      ),
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      // Author Row: Avatar + Name + VIP Crown + Time + Game Badge
                      Row(
                        ...
                        children: [
                          ...
                          // Game Badge (BGMI / GTA VI / Valorant)
                          Container(
